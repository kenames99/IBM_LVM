...
#define FEATURE_FUNCTION_ENTRY( FunctionName )  if (  LVM_Common_Services->Logging_Enabled )                                               \
                                                {                                                                     \
                                                                                                                      \
...
#define FEATURE_FUNCTION_EXIT( FunctionName )  if (  LVM_Common_Services->Logging_Enabled )                                              \
                                               {                                                                    \
                                                                                                                    \
